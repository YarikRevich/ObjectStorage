...
/**
 * Represents context sent to ObjectStorage Cluster as a variable during startup operation.
 */
@Getter
@AllArgsConstructor(staticName = "of")
public class ClusterContextEntity {
    /**
     * Contains metadata for a specific ObjectStorage Cluster allocation.
     */
    @AllArgsConstructor(staticName = "of")
    ...
    /**
     * Represents ObjectStorage Cluster configuration used for internal communication infrastructure setup.
     */
    @AllArgsConstructor(staticName = "of")
