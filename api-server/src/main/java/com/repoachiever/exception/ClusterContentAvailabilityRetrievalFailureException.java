...
/**
 * Represents exception used when ObjectStorage Cluster content availability retrieval operation fails.
 */
public class ClusterContentAvailabilityRetrievalFailureException extends IOException {
    ...
    public ClusterContentAvailabilityRetrievalFailureException(Object... message) {
        super(
                new Formatter()
                        .format("ObjectStorage Cluster content availability retrieval operation failed: %s",
